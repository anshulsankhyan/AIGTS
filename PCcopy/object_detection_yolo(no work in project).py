...
#classesFile = "./data/voc.names";
classesFile = "./data/coco.names";
#classesFile = "./data/openimages.names";
...
#false value
#modelConfiguration = "./cfg/yolov2-tiny-voc.cfg";
#modelWeights = "./weights/yolov2-tiny-voc.weights";
...
#modelConfiguration = "./cfg/yolov3-openimages.cfg";
#modelWeights = "./weights/yolov3-openimages.weights";
...
while cv.waitKey(1) < 0:
    ...
    outs = net.forward(getOutputsNames7(net))
